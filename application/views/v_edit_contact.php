                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <h4 class="page-title">Edit Customer contact Data</h4>
                            <ol class="breadcrumb">
                        ...
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <p class="text-muted font-13 m-b-30">
                                    Insert data for customer record.
                                </p>
                                <?php foreach ($contactEdit as $list) { ?>
                                    <form action="<?php echo base_url() . 'c_contact/Update_contact' ?>" method="post" data-parsley-validate novalidate>
                                        <div class="form-group">
                                            <label hidden>ID*</label>
                                            <input type="hidden" name="ID" hidden value="<?= $list->id_user ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="fname">First Name*</label>
                                            <input type="text" name="fname" value="<?= $list->user_fname ?>" parsley-trigger="change" required placeholder="Enter first name" class="form-control" id="userName">
                                        </div>
                                        <div class="form-group">
                                            <label>Last Name*</label>
                                            <input type="text" name="lname" value="<?= $list->user_lname ?>" parsley-trigger="change" required placeholder="Enter last name" class="form-control" id="emailAddress">
                                        </div>
                                        <div class="form-group">
                                            <label>Gender*</label>
                                        ...
                                        <div class="form-group">
                                            <label>Email*</label>
                                            <input type="email" name="email" value="<?= $list->user_email ?>" placeholder="Enter Phone Number" required class="form-control">
                                        </div>
                                        <div class="form-group">
                                       ...
                                       <select name="role" parsley-trigger="change" placeholder="Enter Role" required class="form-control" style="color:grey">
	                                        <option <?php if ($list->user_type_role == "Customer") echo "selected"; ?>>Customer</option>
                                            <option <?php if ($list->user_type_role == "Supplier") echo "selected"; ?>>Supplier</option>
                                            <option <?php if ($list->user_type_role == "Government") echo "selected"; ?>>Government</option>
                                       </select>
                                    </div>
                                        ...
                                        <p class="text-muted font-13 m-b-30">
                                            Insert data for required field.
                                        </p>
                                        <div class="form-group">
                                            <label>Address*</label>
                                            <input type="text" name="address" value="<?= $list->user_address ?>" parsley-trigger="change" required placeholder="Enter first name" class="form-control" id="userName">
                                        </div>
                                        <div class="form-group">
                                            <label>State*</label>
                                            <input type="text" name="state" value="<?= $list->user_state ?>" parsley-trigger="change" required placeholder="Enter last name" class="form-control" id="emailAddress">
                                        </div>
                                        <div class="form-group">
                                            <label>Postcode*</label>
                                            <input type="text" name="postcode" value="<?= $list->user_postcode ?>" parsley-trigger="change" required placeholder="Enter last name" class="form-control" id="emailAddress">
                                        </div>
                                        <div class="form-group">
                                            <label>City*</label>
                                            <input type="text" name="city" value="<?= $list->user_city ?>" parsley-trigger="change" required placeholder="Enter last name" class="form-control" id="emailAddress">
                                        </div>
