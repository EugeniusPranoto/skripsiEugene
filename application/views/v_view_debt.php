                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <p class="text-muted font-13 m-b-30">
                               List of Account Rececivable data 
                            </p>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <?php
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url(). 'c_debt/updateDebt/'.$list->id_debt; ?>">
                                            <button class="btn btn-icon waves-effect waves-light btn-warning">
                                                </i>Paid</button>
                                        </a>
                                        <a href="<?php echo base_url(). 'c_debt/edit_debt/'.$list->id_debt; ?>">
                                            <button class="btn btn-icon waves-effect waves-light btn-success">
                                                </i>Installement</button>
                                        </a>
