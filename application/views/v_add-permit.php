                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Create New Expidition Permit</h4>
                                <ol class="breadcrumb">
                                    <li><a href="#">Dashboard</a></li>
                                    <li class="active">Add Permit</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
							<div class="col-lg-12">
								<div class="card-box">
									<h4 class="m-t-0 header-title"><b>Data Permit</b></h4>
									...
									<form action="#" data-parsley-validate novalidate>
										...
										<div class="form-group">
											...
											<input id="date" type="date" placeholder="date" required class="form-control">
                                        </div>

                                        <br>
                                        <br>

                                        <h4 class="m-t-0 header-title"><b>Data Recepient</b></h4>
        									<p class="text-muted font-13 m-b-30">
                                                Insert data for required field.
                                            </p>
                                            <div class="form-group">
