                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Edit Existing Customer Schedule</h4>
                                <ol class="breadcrumb">
                        ...
                        <div class="row">
							<div class="col-lg-12">
								<div class="card-box">
                                    ...
                                    <?php foreach($scheduleEdit as $list) { ?>            
									<form action="<?php echo base_url(). 'c_schedule/Update_schedule' ?>" method = "post"  data-parsley-validate novalidate>
                                        <div class="form-group">
											<label hidden>ID*</label>
											<input type="text" hidden name="ID" value="<?= $list->id_schedule?>" parsley-trigger="change" required placeholder="Enter Username" class="form-control">
										</div>
                                        <div class="form-group">
											<label>Schedule Name*</label>
											<input type="text" name="schedule" value="<?= $list->schedule_name?>" parsley-trigger="change" required placeholder="Enter schedule name" class="form-control" id="userName">
                                        </div>
                                        <div class="form-group">
											<label>Customer Name*</label>
											<input type="text" name="name" value="<?= $list->schedule_customer?>" parsley-trigger="change" required placeholder="Enter customer name" class="form-control" id="userName">
										</div>
										...
										<div class="form-group">
											...
											<div class="input-group m-b-15">
													<div class="bootstrap-timepicker">
														<input id="timepicker2" name="time" value="<?= $list->schedule_time?>" type="time" class="form-control">
													</div>
										...
										<div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input value="<?= $list->schedule_date?>" name="date" class="form-control" placeholder="mm/dd/yyyy" id="datepicker-autoclose">
                                                <span class="input-group-addon bg-custom b-0 text-white"><i class="icon-calender"></i></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
											<label>Schedule Description*</label>
											<input type="text" name="description" value="<?= $list->schedule_description?>"placeholder="Enter schedule description" required class="form-control">
                                        </div>
