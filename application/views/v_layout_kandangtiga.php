            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">
                                <?php foreach ($layout3 as $list) { ?>
                                    <h4 class="m-t-0 header-title"><b> <?php echo $list->layout_name ?></b></h4>
                                    <h4 class="m-t-0 header-title" style="float:right; font-size:14px"><button type="button" class="btn btn-default waves-effect waves-light"></button>
                                        : Box Filled </b><br>
                                        <button type="button" class="btn btn-white waves-effect"></button>
                                        : Box EMPTY </b></h4>
                                    ...
                                    <h4 class="m-t-0 header-title"><b>SPACE LEFT : <?= 96 - count($count_layout_three) ?> </b></h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <?php foreach ($layout3 as $list) {
                                                        ...
                                                        <table border="1">
                                                            <tr>
                                                                <th rowspan="6"> G A T E</th>

                                                                <td colspan="16" style="text-align:center; font-size:12px;padding:0px">FOODLET</td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <?php for ($i = 1; $i <= $a / 6; $i++) { ?>
                                                                    ...
                                                                    <?php foreach ($check_layout as $list) { ?>
                                                                        <?php if ($list->layout_box_number == $i) { ?>
                                                                            <td>
                                                                                <button type="button" onclick="modal(<?php echo $list->id_item; ?>, <?php echo $i ?>)" class="btn waves-effect waves-light" style="background-color:grey; color:white; width:100%" data-toggle="modal" data-target="#custom-width-modal<?php echo $i; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;"><?php echo $i ?></button>
                                                                            </td>
                                                                        <?php $flag = 1;
                                                                                        } ?>
                                                                    <?php
                                                ...
                                                <ul class="pagination pagination-split pull-right">
                                                    ...
                                                    <li class="active">
                                                        <a href="<?php echo base_url() . 'c_layout/layoutiga' ?>">1</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'c_layout/layoutiga_2' ?>">2</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'c_layout/layoutiga_3' ?>">3</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'c_layout/layoutiga_2' ?>"><i class="fa fa-angle-right"></i></a>
                                                    </li>
                                                </ul>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <p class="text-muted font-13 m-b-30">
                                    Display Moved Item on First Shed
                                </p>
                                <div class="form-group">
                                    <label>Cow Code*</label>
                                    <select class="form-control" name="id_item" id="id_item">
                                        <?php
                                        foreach ($history as $listHistory) { ?>
                                            <option value="<?= $listHistory->id_item ?>"><?= $listHistory->item_code ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <br>
                                ...
                                <table border=1 style="width:100%">
                                    <tr>
                                        ...
                                        <th style="text-align:center">Time Moved</th>
                                        <th style="text-align:center">Layout Name</th>
                                        <th style="text-align:center">Box Number (Previous) </th>
                                        <th style="text-align:center">Box Number (Current)</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group" id="layoutB"></div>
                                        </td>
                                        <td>
                                            <div class="form-group" id="layoutA"></div>
                                        </td>
                                    </tr>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (date = 0; date < data.length; date++) {
                    ...
                    const formattedDate = changeDateFormatTo(data[date].layout_details_date);
                    html2 += '<input type="text" style="text-align:center" value=' + formattedDate + ' class="form-control">';
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url() . 'c_layout/InsertItem_3/' . $i ?>" method="post" data-parsley-validate novalidate>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
