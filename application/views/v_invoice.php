                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">View Created Invoice</h4>
                                <ol class="breadcrumb">
                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Customer Invoice </b></h4>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>21/03/2019</td>
                                    <td>4 orang hadir</td>
                                    <td><a href="<?php echo base_url(). 'c_schedule/edit_schedule' ?>"><button class="btn btn-icon waves-effect waves-light btn-warning"> <i class="fa fa-wrench"></i></button></a>
                                    <button class="btn btn-icon waves-effect waves-light btn-danger"> <i class="fa fa-remove"></i> </button>

                                    <a href="<?php echo base_url(). 'c_invoice/print_invoice' ?>"><button class="btn btn-inverse waves-effect waves-light"> <i class="fa fa-envelope-o m-r-5"></i> <span>Print</span> </button></a>
                                </td>
                                </tr>
