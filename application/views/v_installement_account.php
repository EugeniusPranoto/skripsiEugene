                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <form action="<?php echo base_url() . 'c_debt/InsertInstallement' ?>" method="post" data-parsley-validate novalidate>
                                    <div class="form-group">
                                        <label>First Name*</label>
                                        <input type="text" name="fname" readonly parsley-trigger="change" value="<?= $list->debt_fname ?>" required placeholder="Enter First Name" class="form-control" >
                                    </div>
                                    <div class="form-group" id="lname">
                                        <label for="lname">Last Name*</label>
                                        <input type="text" name="lname" readonly parsley-trigger="change" value="<?= $list->debt_lname ?>" required placeholder="Enter Last Name" class="form-control" >
                                    </div>
                                    <div class="form-group" id="phone">
                                        <label for="lname">Phone Number*</label>
                                        <input type="number" name="phone" readonly parsley-trigger="change" value="<?= $list->debt_phone ?>" required placeholder="Enter Phone Number" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Deadline*</label>
                                        <div class="input-group">
                                            <input type="text" name="date" readonly class="form-control" placeholder="mm/dd/yyyy" value="<?= $list->debt_date ?>">
                                    ...
                                    <div class="form-group">
                                        <label>Date*</label>
                                        <div class="input-group">
                                            <input type="text" name="deadline" readonly class="form-control" placeholder="mm/dd/yyyy" value="<?= $list->debt_deadline ?>">
                                            <span class="input-group-addon bg-custom b-0 text-white"><i class="icon-calender"></i></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            <label class="control-label">Description*</label>
                                            <input type="text" name="description" readonly value="<?= $list->debt_description ?>" placeholder="Enter Description" required class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Total*</label>
                                            <input type="number" name="total" readonly placeholder="Enter Amount" value="<?= $list->debt_amount ?>" required class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Amount*</label>
                                            <input type="number" name="amount"  placeholder="Enter Amount To Pay" required class="form-control">
                                        </div>
