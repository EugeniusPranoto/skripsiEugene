                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">View History Incoming Inventory List</h4>
                                <ol class="breadcrumb">
                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Incoming Inventory Report</b></h4>
                            <p class="text-muted font-13 m-b-30">
                               List of created history for reporting system
                            </p>
