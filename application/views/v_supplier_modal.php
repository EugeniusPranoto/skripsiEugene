            ...
            <div class="modal-dialog" style="width:25%;">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="custom-width-modalLabel"><b><?php echo $user_fname ?> <?php echo  $user_lname ?></b></h4>
                    </div>
                    <div class="modal-body">
                        <h4></h4>
                  
                        <p style="font-size:16px"><b> First Name: </b> <?php echo $user_fname ?></p>
                        <hr style="margin-top:-2%">
                        <p><b>Last Name: </b><?php echo $user_lname ?></p>
                        <hr style="margin-top:-2%">
                        <p><b>Department: </b><?php echo $supplier_details_department ?></p>
                        <hr style="margin-top:-2%">
