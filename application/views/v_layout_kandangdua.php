                        ...
                        <div class="col-lg-12">
                            <div class="card-box">
                                <?php foreach ($layout2 as $list) { ?>
                                    ...
                                    <h4 class="m-t-0 header-title"><b>SPACE LEFT : <?= 96 - count($count_layout_dua) ?> </b></h4>
                                        ...
                                        <div class="tab-pane active" id="home">
                                            <div class="row">
                                                ...
                                                <ul class="pagination pagination-split pull-right">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo base_url() . 'c_layout/layoutdua_2' ?>"><i class="fa fa-angle-right"></i></a>
                                                    </li>
                                                </ul>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url() . 'c_layout/InsertItem_2/' . $i ?>" method="post" data-parsley-validate novalidate>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
