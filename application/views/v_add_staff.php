                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <form action="<?php echo base_url() . 'c_staff/InsertStaff' ?>" method="post" data-parsley-validate novalidate>
                                    <div class="form-group">
                                        <label for="username">Username*</label>
                                        <input type="email" name="email" parsley-trigger="change" required placeholder="Enter Email" class="form-control" id="username">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="phone" parsley-trigger="change" placeholder="Enter Phone Number" required class="form-control" id="phone">
                                    </div>
                                    <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" parsley-trigger="change" placeholder="Enter Address" required class="form-control" id="address">
                                    </div>
                                    <div class="form-group">
                                        <label for="address">State*</label>
                                        <input type="text" name="state" parsley-trigger="change" placeholder="Enter State" required class="form-control" id="address">
                                    </div>
                                    <div class="form-group">
                                        <label for="address">Postcode*</label>
                                        <input type="text" name="postcode" parsley-trigger="change" placeholder="Enter Postcode" required class="form-control" id="address">
                                    </div>
                                    <div class="form-group">
                                        <label for="address">City*</label>
                                        <input type="text" name="city" parsley-trigger="change" placeholder="Enter City" required class="form-control" id="address">
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">Image*</label>
                                        <input type="file" name="photo" class="filestyle" data-buttonbefore="true">
                                    </div>
