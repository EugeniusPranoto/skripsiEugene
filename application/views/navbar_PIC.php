            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="<?php echo base_url(). 'c_admin/index_staff' ?>" class="logo" style="letter-spacing:1px; font-size:19px"><span>POLARISLIVESTOCK.</span></a>
                        <!-- Image Logo here -->
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <li class="has_sub">
							 <a href="<?php echo base_url(). 'c_admin/index_staff' ?>" class="waves-effect"><i class="ti-home"></i> <span> Dashboard </span></a>
							 </li>

                        	<li class="text-muted menu-title">Layout & Operational </li>
