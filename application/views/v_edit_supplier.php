                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <h4 class="page-title">Create New Supplier Data</h4>
                            <ol class="breadcrumb">
                                <li><a href="#">Dashboard</a></li>
                                <li class="active">Add Supplier Contact</li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <p class="text-muted font-13 m-b-30">
                                    Insert data for supplier record.
                                </p>
                                <?php foreach ($supplierEdit as $list) { ?>
                                    <form action="<?php echo base_url() . 'c_supplier/Update_supplier' ?>" method="post" data-parsley-validate novalidate>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="supplier" value="<?= $list->supplier_details_department ?>" parsley-trigger="change" required placeholder="Enter last name" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="phone" value="<?= $list->user_phone ?>" parsley-trigger="change" required placeholder="Enter Email" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Email*</label>
                                            <input type="email" name="email" value="<?= $list->user_email ?>" parsley-trigger="change" required placeholder="Enter Email" class="form-control">
                                        </div>
