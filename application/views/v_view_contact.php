                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                <h4 class="m-t-0 header-title"><b>Customer Personal Data</b></h4>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($contact as $list) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url() . 'c_contact/edit_contact/' . $list->id_user; ?>">
                                                        <button class="btn btn-icon waves-effect waves-light btn-warning">
                                                            <i class="ion-edit"></i></button>
                                                    </a>
                                                    <a href="<?php echo base_url() . 'c_contact/delete_contact/' . $list->id_user; ?>">
                                                    ...
                                                    <?php
                                                        ...
                                                        $this->load->view("v_contact_modal.php", $data);
                                                        ?>
                                                </td>
                                            </tr>
                                        <?php $i++;
