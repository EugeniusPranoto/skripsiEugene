	...
	<?php include('navbar.php'); ?>
            ...
            <div class="content-page">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-sm-8 col-lg-4">
                                <div class="card-box widget-box-1 bg-white">
                                    ...
                                    <?php $space1 = 40 - count($count)?>
                                    <?php $used1 = count($count)?>
                                    <h4 class="text-dark"><b>First Shed</b> - Space Left </h4>
                                	<h2 class="text-primary text-center" style="font-size:25px"> <span data-plugin="counterup"><?php echo $space1 ?></span></h2>
                                	<p class="text-muted">Total Used: <?php echo $used1 ?> <span class="pull-right"><i class="fa fa-caret-up text-primary m-r-5"></i>Capacity : 40</span></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8 col-sm-8 col-lg-4">
                                <div class="card-box widget-box-1 bg-white">
                                	<i class="fa fa-info-circle text-muted pull-right inform" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Tooltip on right"></i>
                                    <?php $space2 = 96 - count($count_layout_dua)?>
                                    <?php $used2 = count($count_layout_dua)?>
                                    <h4 class="text-dark"><b>Second Shed </b> - Space Left </h4>
                                	<h2 class="text-pink text-center"><span data-plugin="counterup"><?php echo $space2 ?></span></h2>
                                	<p class="text-muted">Total Used:<?php echo $used2 ?><span class="pull-right"><i class="fa fa-caret-down text-danger m-r-5"></i>Capacity : 96</span></p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8 col-sm-8 col-lg-4">
                                <div class="card-box widget-box-1 bg-white">
                                	<i class="fa fa-info-circle text-muted pull-right inform" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Tooltip on right"></i>
                                    <?php $space3 = 96 - count($count_layout_three)?>
                                    <?php $used3 = count($count_layout_three)?>
                                    <h4 class="text-dark"><b>Third Shed </b> - Space Left </h4>
                                	<h2 class="text-success text-center"><span data-plugin="counterup"><?php echo $space3 ?></span></h2>
                                	<p class="text-muted">Total Used: <?php echo $used3 ?> <span class="pull-right"><i class="fa fa-caret-up text-primary m-r-5"></i>Capacity : 96</span></p>
                                </div>
                            </div>
                ...
                <footer class="footer text-right">
                    © 2016. All rights reserved. PT. Polaris Graha Internusa
                </footer>
