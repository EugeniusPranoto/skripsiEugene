                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Create New Order Data</h4>
                                <ol class="breadcrumb">
							...
							<div class="col-lg-12">
								<div class="card-box">
									...
									<div class="form-group">
										...
										<input id="date" type="number" placeholder="Enter Address" required class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
										...
										<input id="date" type="text" placeholder="Enter Name" required class="form-control">
                                     </div>
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
										...
										<input id="date" type="number" placeholder="Notes" required class="form-control">
                                     </div>
