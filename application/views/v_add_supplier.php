                        ...
                        <div class="row">
							<div class="col-lg-12">
								<div class="card-box">
									...
									<form action="<?php echo base_url(). 'c_supplier/InsertSupplier' ?>" method = "post" data-parsley-validate novalidate>
                                    <div class="form-group">
											<label>Supplier Department*</label>
											<input type="text" name="supplier" parsley-trigger="change" required placeholder="Enter last name" class="form-control" >
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="number" name="phone" parsley-trigger="change" required placeholder="Enter Email" class="form-control" >
                                        </div>
                                        <div class="form-group">
											<label>Email*</label>
