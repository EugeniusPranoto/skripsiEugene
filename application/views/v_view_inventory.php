                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">View Inventory List</h4>
                                <ol class="breadcrumb">
                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Active Inventory Report</b></h4>
                            <p class="text-muted font-13 m-b-30">
                               List of Available Cows                            </p>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <tr>
                                <td>
                                    <?php echo $list->item_code ?></td>
                                    <td>Bali Cow</td>
                                    <td><?php echo $list->item_trip ?></td>
                                    <td><?php echo $list->item_arrival ?></td>
                                    <td><?php echo $list->item_weight ?></td>
                                    <td><?php echo $list->item_price ?></td>
                                    <td>Paid</td>
                                    <td ><a href="<?php echo base_url(). 'c_debt/edit_debt' ?>"><button class="btn btn-icon waves-effect waves-light btn-warning"> <i class="fa fa-wrench"></i></button></a>
                                    <button class="btn btn-icon waves-effect waves-light btn-danger"> <i class="fa fa-remove"></i> </button> <button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#custom-width-modal">View Data</button>
