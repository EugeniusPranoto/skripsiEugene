                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <h4 class="page-title">Create New Employee Data</h4>
                            <ol class="breadcrumb">
                        ...
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <p class="text-muted font-13 m-b-30">
                                    Insert data for Employee record.
                                </p>
                                <?php foreach ($employeeEdit as $list) { ?>
                                    <form action="<?php echo base_url() . 'c_employee/Update_Employee' ?>" method="post" data-parsley-validate novalidate>
                                        <div class="form-group">
                                            <label hidden>ID*</label>
                                            <input type="hidden" name="ID" value="<?= $list->id_user ?>" parsley-trigger="change" required placeholder="Enter first name" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="phone" value="<?= $list->user_phone ?>" parsley-trigger="change" required placeholder="Enter Phone Number" class="form-control">
                                        </div>
                                        <br>
                                        ...
                                        <div class="form-group">
                                            <label>Address*</label>
                                            <input type="text" name="address" value="<?= $list->user_address ?>" parsley-trigger="change" required placeholder="Enter Address" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>State*</label>
                                            <input type="text" name="state" value="<?= $list->user_state ?>" parsley-trigger="change" required placeholder="Enter State" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Postcode*</label>
                                            <input type="text" name="postcode" value="<?= $list->user_postcode ?>" parsley-trigger="change" required placeholder="Enter Postcode" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>City*</label>
                                            <input type="text" name="city" value="<?= $list->user_city ?>" parsley-trigger="change" required placeholder="Enter City" class="form-control">
                                        </div>

                                        <br>

                                        <h4 class="m-t-0 header-title"><b>Job Information</b></h4>
                                        <p class="text-muted font-13 m-b-30">
                                            Insert data for Employee record.
                                        </p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="hiredate" value="<?= $list->employee_details_hiredate ?>" parsley-trigger="change" required placeholder="Enter Hire Date" required class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label>Department*</label>
                                            <input type="text" name="department" value="<?= $list->employee_details_department ?>" parsley-trigger="change" required placeholder="Enter department" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label>Salary*</label>
                                            <input type="number" name="salary" value="<?= $list->employee_details_salary ?>" parsley-trigger="change" required placeholder="Enter Salary" class="form-control">
                                        </div>
