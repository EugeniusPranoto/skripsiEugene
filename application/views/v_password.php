                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-lg-12">
								<div class="card-box">
									<h4 class="m-t-0 header-title"><b>Password Configuration</b></h4>
									<p class="text-muted font-13 m-b-30">
	                                    Change Password Settings.
	                                </p>
                                    <?php foreach($Passwordedit as $list) { ?>     
									<form action ="<?php echo base_url().'c_login/update_password/'.$this->session->id_user;?>" method = "post" data-parsley-validate novalidate>
                                        <div class="form-group">
											<label hidden>ID*</label>
											<input type="hidden" name="ID" value="<?= $list->id_user ?>" hidden  class="form-control">
										</div>
                                        <div class="form-group">
											<label>Old Password*</label>
											<input type="password" name="oldpass"  parsley-trigger="change" required placeholder="Enter Old Password" class="form-control">
										</div>                                       
                                        <div class="form-group">
											<label>New Password*</label>
											<input type="password" name="newpass" parsley-trigger="change" required placeholder="Enter New Password" class="form-control">
                                        </div>
                                        <div class="form-group">
											<label>Re-Type Password*</label>
											<input type="password" name="repass" parsley-trigger="change" required placeholder="Re-Type password" class="form-control">
                                        </div>
                                        <br>
										</div>
