                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">View Operational Costing</h4>
                                <ol class="breadcrumb">
                                    <li><a href="#">Dashboard</a></li>
                                    <li class="active">View Operational</li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Daily Operational Cost Data</b></h4>
                            <p class="text-muted font-13 m-b-30">
                               List of Costing data 
                            </p>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        ?>
                                <tr>
                                    <td><?php echo $list->operational_name ?></td>
                                    <td><?php echo $list->operational_date ?></td>
                                    <td><?php echo $list->item_code ?></td>
                                    <td><?php echo $list->operational_inventory ?></td>
                                    <td><?php echo $list->operational_quantity ?></td>
                                    <td><?php echo $list->operational_amount ?></td>
                                    <td>
                                        <a href="<?php echo base_url(). 'c_operational/edit_operational/'.$list->id_operational; ?>">
