                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">View Expidition Permit List</h4>
                                <ol class="breadcrumb">
                                    <li><a href="#">Dashboard</a></li>
                                    <li class="active">View Permit</li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Expidition Permit Report</b></h4>
                            <p class="text-muted font-13 m-b-30">
                               List of created Permit for reporting system
                            </p>
