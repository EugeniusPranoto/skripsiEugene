                        ...
                        <ul class="nav navbar-nav navbar-right pull-right">
                            <li class="dropdown top-menu-item-xs">
                                <a href="#" data-target="#" class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" aria-expanded="true">
                                    <i class="icon-bell"></i> <span class="badge badge-xs badge-danger">
                                        <!--<?= count($notification) ?>--></span>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-lg">
                                    <li class="notifi-title"><span class="label label-default pull-right">New
                                            <!--<?= count($notification) ?>--></span>Notification</li>
            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="ion-android-archive"></i><span>Data Master </span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li class="has_sub">
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="<?php echo base_url() . 'c_schedule/view_active_schedule' ?>">View Active Schedule</a></li>
                                <li><a href="<?php echo base_url() . 'c_schedule/view_schedule' ?>">View Schedule</a></li>
                            </ul>
                        </li>

                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="ion-social-usd	"></i><span> Account Receivable </span> <span class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                                <li><a href="<?php echo base_url() . 'c_debt/existing_debt' ?>">Add Account</a></li>
                                <li><a href="<?php echo base_url() . 'c_debt/view_debt' ?>">View Active Account </a></li>
                                <li><a href="<?php echo base_url() . 'c_debt/paid_debt' ?>">Paid Account</a></li>
                                <li><a href="<?php echo base_url() . 'c_debt/personal_account_receivable' ?>">View History</a></li>
                        ...
                        <li class="has_sub">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="<?php echo base_url() . 'c_layout/layoutsatu' ?>">First Shed</a></li>
                                <li><a href="<?php echo base_url() . 'c_layout/layoutdua' ?>">Second Shed</a></li>
                                <li><a href="<?php echo base_url() . 'c_layout/layoutiga' ?>">Third Shed</a></li>
                            </ul>
                        </li>
                        <li class="has_sub">
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="ion-social-usd"></i><span> Cost </span> <span class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                                <li><a href="<?php echo base_url() . 'c_purchase/add_purchase' ?>">Add Cost</a></li>
                                <li><a href="<?php echo base_url() . 'c_purchase/view_purchase' ?>">View Cost</a></li>
                            </ul>
                        </li>
                        <li class="has_sub">
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="ion-ios7-paper"></i><span>Customer Order</span> <span class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="ion-ios7-compose"></i><span> Delivery Note </span> <span class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                                <!-- <li><a href="<?php echo base_url() . 'c_permit/add_permit' ?>">Create Delivery Note</a></li> -->
                                <li><a href="<?php echo base_url() . 'c_permit/view_permit' ?>">View Delivery Note</a></li>
                            </ul>
                        </li>
                    </ul>
