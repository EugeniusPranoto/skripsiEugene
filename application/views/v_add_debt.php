                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <h4 class="page-title">Create Customer Account Receivable Data</h4>
                            <ol class="breadcrumb">
                                <li><a href="#">Dashboard</a></li>
                                <li class="active">Add Customer Account Receivable</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <form action="<?php echo base_url() . 'c_debt/InsertDebt' ?>" method="post" data-parsley-validate novalidate>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="phone" parsley-trigger="change" required placeholder="Enter Phone Number" class="form-control" id="emailAddress">
                                    </div>
                                    <div class="form-group">
                                        <label>Date*</label>
