                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Edit Customer Debt Data</h4>
                                <ol class="breadcrumb">
                                    <li><a href="#">Dashboard</a></li>
                                    <li class="active">Edit Customer Debt</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
							<div class="col-lg-12">
								<div class="card-box">
									<h4 class="m-t-0 header-title"><b>Debt Information</b></h4>
									<p class="text-muted font-13 m-b-30">
	                                    Insert data for Debt record.
	                                </p>
		                            <?php foreach($debtEdit as $list) { ?>               
                                        <form action="<?php echo base_url(). 'c_debt/Update_debt' ?>" method = "post"  data-parsley-validate novalidate>                                
                                        <div class="form-group">
											<label hidden>ID*</label>
											<input type="text" name="ID" hidden value="<?= $list->id_debt?>"  class="form-control">
										</div>
                                        <div class="form-group">
											<label>First Name*</label>
											<input type="text" name="fname" value="<?= $list->debt_fname?>" parsley-trigger="change" required placeholder="Enter first name" class="form-control" id="userName">
										</div>
										<div class="form-group">
											<label>Last Name*</label>
											<input type="text" name="lname" value="<?= $list->debt_lname?>" parsley-trigger="change" required placeholder="Enter last name" class="form-control" id="emailAddress">
                                        </div>
                                        <div class="form-group">
											<label>Phone Number*</label>
											<input type="number" name="phone" value="<?= $list->debt_phone?>" parsley-trigger="change" required placeholder="Enter last name" class="form-control" id="emailAddress">
                                        </div>
                                        <div class="form-group">
                                            <label>Date*</label>
                                            <div class="input-group">
                                                <input type="text" name="date" class="form-control" value="<?= $list->debt_date?>" placeholder="mm/dd/yyyy" id="datepicker-autoclose">
										...
										<div class="form-group">
											...
											<div class="input-group">
                                                <input type="text" name="deadline"  value="<?= $list->debt_deadline?>" class="form-control" placeholder="mm/dd/yyyy" id="datepicker">
                                                <span class="input-group-addon bg-custom b-0 text-white"><i class="icon-calender"></i></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
											<label class="control-label">Amount*</label>
											<input type="number" name="amount" value="<?= $list->debt_amount?>" placeholder="Enter Debt Amount" required class="form-control">
													</div>
