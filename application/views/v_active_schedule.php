                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">View Schedule List</h4>
                                <ol class="breadcrumb">
                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Customer Schedule Data</b></h4>
                            <p class="text-muted font-13 m-b-30">
                               List of Active Schedule data 
                            </p>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $list->schedule_customer ?></td>
                                    <td><?php echo $list->schedule_time?></td>
                                    <td><?php echo $list->schedule_date ?></td>
                                    <td><?php echo $list->schedule_description ?></td>
                                    <td>
                                        <a href="<?php echo base_url(). 'c_schedule/edit_schedule/'.$list->id_schedule; ?>">
                                            <button class="btn btn-icon waves-effect waves-light btn-warning"> 
                                                <i class="fa fa-wrench"></i></button>
                                        </a>
                                        <a href="<?php echo base_url(). 'c_schedule/delete_schedule/'.$list->id_schedule; ?>">
                                            <button class="btn btn-icon waves-effect waves-light btn-danger">
                                                <i class="fa fa-remove"></i></button> 
                                        </a>
                                        <a href="<?php echo base_url(). 'c_schedule/change_schedule/'.$list->id_schedule; ?>">
