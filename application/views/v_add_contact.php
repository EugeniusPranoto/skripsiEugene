                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <h4 class="page-title">Create New Customer Data</h4>
                            <ol class="breadcrumb">
                                <li><a href="#">Dashboard</a></li>
                                <li class="active">Add Customer Contact</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <form action="<?php echo base_url() . 'c_contact/InsertContact' ?>" method="post" data-parsley-validate novalidate>
                                    <div class="form-group">
                                        <label>First Name*</label>
                                        <input type="text" name="fname" parsley-trigger="change" required placeholder="Enter first name" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Last Name*</label>
                                        <input type="text" name="lname" parsley-trigger="change" required placeholder="Enter last name" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Gender*</label>
                                        <select class="form-control" name="gender" parsley-trigger="change" placeholder="Enter Gender" required class="form-control" style="color:grey">
                                            <option>Male</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="phone" parsley-trigger="change" placeholder="Enter Phone Number" required class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Email*</label>
                                        <input type="email" name="email" parsley-trigger="change" placeholder="Enter Email Address" required class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="postcode" parsley-trigger="change" required placeholder="Enter Postcode" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>City*</label>
